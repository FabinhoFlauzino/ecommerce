        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="footer-about-us">
                    <h2 class="footer-wid-title">Fabinho Flauzino Store</h2>
...
<div class="footer-bottom-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>&copy; 2019 Fabinho Flauzino. <a href="https://github.com/FabinhoFlauzino" target="_blank"><i class="fa fa-github"></i> Fabinho Flauzino</a></p>
                </div>
            </div>
