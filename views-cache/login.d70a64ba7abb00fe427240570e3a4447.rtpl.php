...
<head>
  ...
  <title>Flauzino Store | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Fabinho </b>Flauzino Store</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OU -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Entre com sua conta
        Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Entre com sua conta
        Google+</a>
    </div>
    <!-- /.social-auth-links -->
